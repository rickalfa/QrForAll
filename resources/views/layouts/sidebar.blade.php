...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('user-app.index')}}">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('user-qrs.index')}}">
          ...
          <li class="nav-item">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="16" fill="currentColor" class="bi bi-shield" viewBox="0 0 16 16">
